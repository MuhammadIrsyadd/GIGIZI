  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <header className="text-center mb-16">
        ...
        <p className="text-xl text-foreground/70 italic font-dm-sans leading-relaxed">
      ...
      <div className="prose prose-lg max-w-none text-foreground/80 leading-relaxed space-y-12">
        ...
        <section className="bg-white p-10 rounded-[3rem] border border-text-dark/5 shadow-sm overflow-hidden relative group">
          ...
          <h2 className="text-3xl font-playfair font-bold text-foreground mb-8 flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1">Mangkuk Nutrisi</h4>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1">Daun Hijau Utama</h4>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1">Uap Oranye (Warmth)</h4>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1">Titik Merah (Energi)</h4>
        ...
        <section className="bg-secondary/10 p-10 rounded-[3rem] border border-secondary/20">
          <h2 className="text-3xl font-playfair font-bold text-foreground mb-4 flex items-center gap-3">
